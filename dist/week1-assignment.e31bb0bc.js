...
},{"@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js","buffer":"node_modules/buffer/index.js"}],"node_modules/@tensorflow-models/mobilenet/dist/mobilenet.esm.js":[function(require,module,exports) {
"use strict";
      ...
      switch (s.label) {
        case 0:
          ...
          if (o = e.version.toFixed(2), i = e.alpha ? e.alpha.toFixed(2) : "", t = -1, n = 1, null == e.modelUrl) {
            if (!(o in MODEL_INFO)) throw new Error("Invalid version of MobileNet. Valid versions are: " + Object.keys(MODEL_INFO));
            if (!(i in MODEL_INFO[o])) throw new Error("MobileNet constructed with invalid alpha " + e.alpha + ". Valid multipliers for this version are: " + Object.keys(MODEL_INFO[o]) + ".");
  ...
  return e.prototype.load = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (t) {
        switch (t.label) {
          case 0:
            return this.modelUrl ? (e = this, [4, (0, _tfjsConverter.loadGraphModel)(this.modelUrl)]) : [3, 2];

          case 1:
            return e.model = t.sent(), [3, 4];

          case 2:
            return a = MODEL_INFO[this.version][this.alpha].url, r = this, [4, (0, _tfjsConverter.loadGraphModel)(a, {
              fromTFHub: !0
            })];
          ...
          case 4:
            return [4, (o = (0, tf.tidy)(function () {
              return i.model.predict((0, tf.zeros)([1, IMAGE_SIZE, IMAGE_SIZE, 3]));
            })).data()];
    ...
    var r = this;
    return void 0 === a && (a = !1), (0, tf.tidy)(function () {
      e instanceof tf.Tensor || (e = tf.browser.fromPixels(e));
      var o = e.toFloat().mul(r.normalizationConstant).add(r.inputMin),
          i = o;

      if (e.shape[0] !== IMAGE_SIZE || e.shape[1] !== IMAGE_SIZE) {
        i = tf.image.resizeBilinear(o, [IMAGE_SIZE, IMAGE_SIZE], !0);
      }

      var t,
          n = i.reshape([-1, IMAGE_SIZE, IMAGE_SIZE, 3]);

      if (a) {
        var l = EMBEDDING_NODES[r.version];
        t = r.model.execute(n, l).squeeze([1, 2]);
      } else {
        t = r.model.predict(n).slice([0, 1], [-1, 1e3]);
      }
    ...
    return void 0 === a && (a = 3), __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (i) {
        switch (i.label) {
          case 0:
            return [4, getTopKClasses(r = this.infer(e), a)];
...
var mobilenet = _interopRequireWildcard(require("@tensorflow-models/mobilenet"));
...
const app = async () => {
  ...
  loadBtn.setAttribute('disabled', ''); // Event Listeners
  ...
  imageInput.addEventListener("change", e => displayImage(image, imageInput.value, loadBtn)); // Load model asynchronously
...
const isURLValid = url => true; // start app


app();
},{"@tensorflow-models/mobilenet":"node_modules/@tensorflow-models/mobilenet/dist/mobilenet.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62432" + '/');
...
//# sourceMappingURL=/week1-assignment.e31bb0bc.js.map